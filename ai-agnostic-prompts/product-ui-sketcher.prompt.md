# product-ui-sketcher · prompt

> **触发场景**：接收一段功能描述和交互细节，产出 product.md 用的 ASCII 线框图 + 意图说明。可选同步产出 html+tailwind mockup 放到 docs/ui-mockups/。本 skill 只产出"够用"的视觉，不追求"好看"——好看是后续美化的事。
>
> **用法**：把"# product-ui-sketcher"以下的全部内容粘到你 AI 对话窗口，AI 会按里面的步骤工作。
