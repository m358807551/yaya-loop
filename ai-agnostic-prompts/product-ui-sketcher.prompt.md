# product-ui-sketcher · portable prompt

> **When to use:** Create a `Product UI sketch`, `ASCII wireframe`, optional `HTML mockup`, `UI 线框`, `ASCII 界面`, or `HTML mockup` from Product behavior and interactions.
>
> **Usage:** Paste everything below the next heading into an AI coding-agent conversation. Return the result to `product-change-standardizer`.
