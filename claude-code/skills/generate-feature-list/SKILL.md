...
description: Generate or explicitly regenerate the initial three-file Feature plan from Product and Coding Rules. Use for first-time Feature planning or a confirmed full replacement; use sync-feature-list for incremental changes. English triggers: generate feature list, initialize task list, decompose the product. 中文触发：生成 feature-list、初始化任务列表、拆解产品功能。
---
